...
ARMIPS ?= armips
ARMIPS_FLAGS = -sym test.sym -equ MOVE_INGAME_TRADE_ABILITYNUM $(MOVE_INGAME_TRADE_ABILITYNUM) -equ NUM_INGAME_TRADES $(NUM_INGAME_TRADES)
...
ifneq ($(MOVE_INGAME_TRADE_ABILITYNUM),0)
